...
/*   Updated: 2023/04/14 13:39:36 by smayrand         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//Function
	void Bureaucrat::signForm(Form &form)
	{
		...
		catch (GradeTooLowSignException)
		{
			std::cout << this->getName() << " couldn't sign form because "<< GradeTooLowSignException().Too_LowS() << std::endl;
		}	
		catch (AlreadySignedException)
		{
			std::cout << this->getName() << " couldn't sign form because " << AlreadySignedException().Already_Signed() << std::endl;
		}	
	}
